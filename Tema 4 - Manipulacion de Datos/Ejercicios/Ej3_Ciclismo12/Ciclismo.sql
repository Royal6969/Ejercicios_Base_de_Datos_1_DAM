...
CREATE TABLE ciclista (
  DORSAL VARCHAR2(25) PRIMARY KEY,
  NOMBRE VARCHAR2(45) DEFAULT NULL,
  EDAD INTEGER DEFAULT NULL,
  NOMEQ VARCHAR2(25) DEFAULT NULL,
  CONSTRAINT FK_CICLISTA_ES_PARTE__EQUIPO
    FOREIGN KEY (NOMEQ)
    REFERENCES equipo (NOMEQ));

CREATE TABLE etapa (
  NETAPA INTEGER PRIMARY KEY,
  KM NUMBER(3) DEFAULT NULL,
  SALIDA VARCHAR2(45) DEFAULT NULL,
  LLEGADA VARCHAR2(45) DEFAULT NULL,
  DORSAL VARCHAR2(45) DEFAULT NULL,
  CONSTRAINT FK_ETAPA_TIENE_CICLISTA
    FOREIGN KEY (DORSAL)
    REFERENCES ciclista(DORSAL));

CREATE TABLE maillot (
  CODIGO VARCHAR2(25) PRIMARY KEY,
  TIPO VARCHAR2(45) DEFAULT NULL,
  COLOR VARCHAR2(45) DEFAULT NULL,
  PREMIO VARCHAR2(45) DEFAULT NULL);

CREATE TABLE llevar (
  DORSAL VARCHAR2(25) NOT NULL,
  NETAPA INTEGER NOT NULL,
  CODIGO VARCHAR2(25) NOT NULL,
  CONSTRAINT PK_LLEVAR PRIMARY KEY (DORSAL, NETAPA, CODIGO),
  CONSTRAINT FK_LLEVAR_CUENTA_CO_CICLISTA
    FOREIGN KEY (DORSAL) REFERENCES ciclista (DORSAL),
  CONSTRAINT FK_LLEVAR_POSEEN_ETAPA
    FOREIGN KEY (NETAPA) REFERENCES etapa (NETAPA),
  CONSTRAINT FK_LLEVAR_POSEE_MAILLOT
    FOREIGN KEY (CODIGO) REFERENCES maillot (CODIGO));

CREATE TABLE puerto (
  NOMPUERTO VARCHAR2(45) PRIMARY KEY,
  ALTURA NUMBER(4) DEFAULT NULL,
  CATEGORIA VARCHAR2(45) DEFAULT NULL,
  PENDIENTE number(7,5) DEFAULT NULL,
  NETAPA INTEGER DEFAULT NULL,
  DORSAL VARCHAR2(25) DEFAULT NULL,
  CONSTRAINT FK_PUERTO_ESTA_EN_CICLISTA
    FOREIGN KEY (DORSAL) REFERENCES ciclista (DORSAL),
  CONSTRAINT FK_PUERTO_TIENEN_ETAPA FOREIGN KEY (NETAPA)
    REFERENCES etapa (NETAPA));

INSERT INTO equipo VALUES ('Amore Vita','Ricardo Padacci');
INSERT INTO equipo VALUES ('Artiach','José Perez');
...
INSERT INTO puerto VALUES ('Arcalis',2230,'E',6.50000,10,4);
INSERT INTO puerto VALUES ('Cerler-Circo de Ampriu',2500,'E',5.87000,11,9);
INSERT INTO puerto VALUES ('Coll de la Comella',1362,'1',8.07000,10,2);
INSERT INTO puerto VALUES ('Coll de Ordino',1980,'E',5.30000,10,7);
INSERT INTO puerto VALUES ('Cruz de la Demanda',1850,'E',7.00000,11,20);
INSERT INTO puerto VALUES ('Lagos de Covadonga',1134,'E',6.86000,16,42);
INSERT INTO puerto VALUES ('Navacerrada',1860,'1',7.50000,19,2);
INSERT INTO puerto VALUES ('Puerto de Alisas',672,'1',5.80000,15,1);
INSERT INTO puerto VALUES ('Puerto de la Morcuera',1760,'2',6.50000,19,2);
INSERT INTO puerto VALUES ('Puerto de Mijares',1525,'1',4.90000,18,24);
INSERT INTO puerto VALUES ('Puerto de Navalmoral',1521,'2',4.30000,18,2);
INSERT INTO puerto VALUES ('Puerto de Pedro Bernardo',1250,'1',4.20000,18,25);
INSERT INTO puerto VALUES ('Sierra Nevada',2500,'E',6.00000,2,26);
